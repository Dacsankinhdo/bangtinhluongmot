...
const SOURCE_STANDARD_DAYS_FIELD = process.env.LARK_SOURCE_STANDARD_DAYS_FIELD || "";
...
const DESTINATION_STANDARD_DAYS_FIELD = process.env.LARK_DESTINATION_STANDARD_DAYS_FIELD || "Ngày chuẩn";
const DESTINATION_OT_WORKDAY_FIELD =process.env.LARK_DESTINATION_OT_WORKDAY_FIELD || "Tăng ca ngày thường";
const DESTINATION_OT_WEEKEND_FIELD =process.env.LARK_DESTINATION_OT_WEEKEND_FIELD || "Tăng ca ngày nghỉ tuần";
const DESTINATION_OT_HOLIDAY_FIELD =process.env.LARK_DESTINATION_OT_HOLIDAY_FIELD || "Tăng ca ngày lễ";
